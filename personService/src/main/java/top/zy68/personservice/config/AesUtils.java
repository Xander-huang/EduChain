...
public class AesUtils {
    ...
    public static final String APPEND_PWD = "guet6666";
     ...
     * @return 加密数据
     */
    public  String aesEncrypt(String content, String password, String iv) throws Exception {
...
public static String handPwdLength(String password){

    if(password.length() <16 ){
        password = password +APPEND_PWD.substring(0,16 - password.length());
