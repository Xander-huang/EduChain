...
import top.zy68.personservice.exception.ParamException;
...
public class CommonUtils {
     ...
     * base response
     */
    public static ResponseBean buildSuccessRspVo(Object data) {
        ResponseBean baseRspVo = new ResponseBean(CodeMessageEnums.SUCCEED);
     ...
     * base page response
     */
    public static ResponseBean buildSuccessPageRspVo(Object data, long totalCount) {
        ResponseBean basePageRspVo = new ResponseBean(CodeMessageEnums.SUCCEED);
