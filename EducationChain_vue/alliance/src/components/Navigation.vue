  ...
  computed: {
    ...
    paths() {
      ...
      for (let i = 0; i < pathList.length; i++) {
        ...
        } else if (pathList[i] == "alliance") {
          pathList.splice(i, 1, "Function");
        } else if (pathList[i] == "major") {
          pathList.splice(i, 1, "Major");
        } else if (pathList[i] == "course") {
          pathList.splice(i, 1, "Course");
        } else if (pathList[i] == "student") {
          pathList.splice(i, 1, "Student");
        } else if (pathList[i] == "education") {
          pathList.splice(i, 1, "Grade");
        } else if (pathList[i] == "achieve") {
          pathList.splice(i, 1, "Achieve");
        } else if (pathList[i] == "manager") {
          pathList.splice(i, 1, "User");
        }
      }
      return pathList;
    },
